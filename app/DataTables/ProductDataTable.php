    ...
    public function dataTable(QueryBuilder $query) : EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($query) {
                $edit_btn = "<a class='btn btn-warning mr-2' href='" . route('admin.child-category.edit', $query->id) . "' /><i class='uil-pen'/></i></a>";
                $del_btn = "<a class='btn btn-danger mr-2 delete-item' href='" . route('admin.child-category.destroy', $query->id) . "' /><i class='uil-trash'/></i></a>";
                ...
                <div class="dropdown-menu mr-3 border-none">
                    <a class="dropdown-item shadow-lg rounded" href="#">Action</a>
                </div>';
