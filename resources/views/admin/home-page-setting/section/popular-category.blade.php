<div class="tab-pane fade active show" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
    <div class="card border">
        <div class="row m-2">
            <div class="col-12">
                <form action="{{ route('admin.popular-category') }}" method="post">
                    @csrf
                    @method('put')
                    <h4>Category 1</h4>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                <select class="custom-select main-category mb-3" name="cat_three">
                                    <option value="">Select</option>
                                    @foreach ($categories as $category)
                                        <option
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                @endphp
                                <select class="custom-select sub-category mb-3" name="sub_cat_three">
                                    <option value="">Select</option>
                                    @foreach ($subCategories as $subCategory)
                                        <option
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                @endphp
                                <select class="custom-select child-category mb-3" name="child_cat_three">
                                    <option value="">Select</option>
                                    @foreach ($childCategories as $childCategory)
                                        <option
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                <select class="custom-select main-category mb-3" name="cat_four">
                                    <option value="">Select</option>
                                    @foreach ($categories as $category)
                                        <option
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                @endphp
                                <select class="custom-select sub-category mb-3" name="sub_cat_four">
                                    <option value="">Select</option>
                                    @foreach ($subCategories as $subCategory)
                                        <option
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                @endphp
                                <select class="custom-select child-category mb-3" name="child_cat_four">
                                    <option value="">Select</option>
                                    @foreach ($childCategories as $childCategory)
                                        <option
