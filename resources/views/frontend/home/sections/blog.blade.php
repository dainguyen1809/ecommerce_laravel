<section id="ts__blogs" class="home_blogs">
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
        ...
        <div class="row home_blog_slider">
            <div class="col-xl-3">
                <div class="ts__single_blog ts__single_blog_2">
                    <a class="ts__blog_img" href="#">
                        <img src="images/blog_1.jpg" alt="blog" class="img-fluid w-100">
                    </a>
                    <div class="ts__blog_text">
                        <a class="blog_top red" href="#">women's</a>
                        <div class="ts__blog_text_center">
