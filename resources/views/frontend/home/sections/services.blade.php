<section id="ts__home_services" class="home_service_2">
    <div class="container">
        <div class="row">
            <div class="col-xl-3 col-sm-6 col-lg-3 pe-lg-0">
                <div class="ts__home_services_single home_service_single_2 border_left">
            ...
            <div class="col-xl-3 col-sm-6 col-lg-3 pe-lg-0">
                <div class="ts__home_services_single home_service_single_2">
