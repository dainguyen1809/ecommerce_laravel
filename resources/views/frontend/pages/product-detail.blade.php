...
@section('content')
    ...
    <section id="ts__product_details">
        <div class="container">
            <div class="ts__details_bg">
                <div class="row">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="ts__pro_det_description">
                        <div class="ts__details_bg">
                            ...
                            <div class="tab-content" id="pills-tabContent4">
                                <div class="tab-pane fade  show active " id="pills-home22" role="tabpanel"
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <div class="ts__description_area">
                                                <h1>Heading</h1>
                                ...
                                <div class="tab-pane fade" id="pills-contact2" role="tabpanel"
                                    ...
                                    <div class="ts__pro_det_review">
                                        <div class="ts__pro_det_review_single">
                                            <div class="row">
                                                <div class="col-xl-8 col-lg-7">
                                                    <div class="ts__comment_area">
                                                        <h4>Reviews <span>{{ count($reviews) }}</span></h4>
                                                        @foreach ($reviews as $review)
                                                            <div class="ts__main_comment">
                                                                <div class="ts__comment_img">
                                                                    <img src="{{ $review->user->avatar }}" alt="user"
                                                                        class="img-fluid w-100">
                                                                </div>
                                                                <div class="ts__comment_text reply">
                                                                    <h6> {{ $review->user->name }}
                                                                        <span>
                                                                            {{ $review->rating }}
                                                                            <i class="fas fa-star"></i>
                                                ...
                                                <div class="col-xl-4 col-lg-5 mt-4 mt-lg-0">
                                                    @auth
                                                        ...
                                                        @endphp
                                                        @if ($isBought === true)
                                                            <div class="ts__post_comment rev_mar" id="sticky_sidebar3">
