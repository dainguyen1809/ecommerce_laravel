                ...
                <div class="row mb-3">
                    <div class="text-end">
                        <a class="btn btn-primary"
                            href="{{ route('vendor.products-variant-item.create', [
                        ...
                        <a class="btn btn-secondary"
                            href="{{ route('vendor.products-variant.index', ['product' => $product->id]) }}">
    ...
    <script>
        $(document).ready(function() {
            $('body').on('click', '.change-status', function() {
                ...
                $.ajax({
                    url: "{{ route('vendor.products-variant-item-status.change-status') }}",
                    method: "PUT",
                    headers: {
